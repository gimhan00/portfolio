  ...
  contact: {
    social: {
      GitHub: {
        ...
        url: 'https://github.com/gimhan00',
        icon: Icons.github,
      },
      LinkedIn: {
        name: 'LinkedIn',
        tooltip: 'LinkedIn Profile',
        url: 'https://www.linkedin.com/in/lasitha-gimhan/',
        icon: Icons.linkedin,
      },
      email: {
        name: 'Send Email',
        tooltip: 'Send Email',
        url: 'mailto:lasithagimhan99@gmail.com',
        icon: Icons.email,
      },
    },
  },
      ...
      <TooltipProvider>
        <Dock direction="middle">
          <DockIcon className="!min-w-40">
            <a
              href="/Lasitha_Gimhan.pdf"
              download="Lasitha_Gimhan.pdf"

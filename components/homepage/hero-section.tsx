      ...
      <div className="w-full">
        ...
        >
          ...
          <div className="col-span-1 space-y-4 md:col-span-1 lg:col-span-3">
            <TypingAnimation
              className="text-start text-xl mt-6 text-black dark:text-white sm:text-2xl"
              texts={[
            ...
            <div className="space-y-3">
              ...
              <BoxReveal boxColor={'#df7ee0'} duration={0.5}>
                <div className="text-3xl font-semibold uppercase mt-3 text-Secondary sm:text-4xl md:text-5xl lg:text-[5rem]">
                  <p className=''>Lasitha</p>
                  <p>Gimhan</p>
                </div>
              </BoxReveal>
            </div>
